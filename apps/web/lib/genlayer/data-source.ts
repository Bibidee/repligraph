...
export async function getStudy(id:string):Promise<Study>{return readContract('get_study',[id])}
export async function getRelation(id:string):Promise<RelationClaim>{return readContract('get_relation',[id])}
export async function listEdges(id:string):Promise<Edge[]>{return readContract('list_edges',[id,0,50])}
export async function searchRelated(id:string,field:string):Promise<Neighbor[]>{return readContract('search_related',[id,field,8])}
